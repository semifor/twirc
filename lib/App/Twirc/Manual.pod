...
App::Twic::Manual - User guide and reference for Twirc
...
it's used by some competent perl codes who may be able to help if you have
trouble.  Try the #twirc channel at L<irc.perl.org>.
...
Finally, follow C<twirc> on twitter.  Changes and updates are announced there.
Sending an @reply to C<twirc> I<may> get a reply, bit C<twirc>'s feed isn't
closely followed at the moment.  That's waiting for a new C<twirc> feature to
allow multiple Twitter feeds.
